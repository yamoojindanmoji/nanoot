  ...
  return (
    <div className="flex flex-col flex-1 pb-20">
      ...
      <Link 
        ...
        className="fixed bottom-24 right-4 w-14 h-14 bg-black text-white rounded-full flex items-center justify-center shadow-lg hover:bg-gray-800 transition-all active:scale-95 z-30"
      >
